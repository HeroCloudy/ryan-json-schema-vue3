import { createVNode as c, mergeProps as m, isVNode as S, defineComponent as I, ref as D, reactive as _, watchEffect as re, computed as w, resolveComponent as L, createTextVNode as F } from "vue";
...
const we = (e, t = {}, o, r, n, s) => {
  ...
  if (o.oneOf) {
    ...
    return n === p.RADIO ? new K(o, r, t).render() : n === p.SELECT ? new T(o, r, t).render() : U();
  }
  return o.format && (o.format === "date" || o.format === "datetime") ? new X(o, r, t).render() : new Re(o, r, t).render();
}, Ie = (e) => {
  const {
    model: t,
    item: o,
  ...
  return r && r[y] === p.SWITCH ? new Y(o, r, t).render() : new Pe(o, r, t).render();
}, Ae = (e) => {
  const {
    model: t,
    item: o,
  ...
  return o.oneOf = o.oneOf ? o.oneOf : s, n === p.SWITCH ? new Y(o, r, t).render() : n === p.RADIO ? new K(o, r, t).render() : n === p.SELECT ? new T(o, r, t).render() : U();
}, Ne = (e) => {
  const {
    model: t,
    item: o,
  ...
  if (o.anyOf) {
    const n = r[y] || "select";
    if (n === p.SELECT)
      return new T(o, r, t).render();
    if (n === p.CHECKBOX)
      return new ve(o, r, t).render();
  }
...
const $ = "ry-json-form", P = /* @__PURE__ */ I({
  name: $,
  props: z,
  setup(e, t) {
    const o = D();
    ...
    const d = {
      ...
      return Object.keys(l).forEach((A) => {
        const N = l[A];
        N.prop = N.prop || A;
        const x = e.uiSchema[A], q = we(N, x, e.model, t.slots, i, d);
        q && b.push(q);
      }), b;
    }, h = w(() => {
      const {
...
const Fe = "ry-json-description", v = /* @__PURE__ */ I({
  name: Fe,
  props: Z,
  setup(e, t) {
    const o = () => {
      ...
      return Object.keys(r).forEach((s) => {
        const i = r[s];
        i.prop = i.prop || s;
        const a = e.uiSchema[s], u = xe(i, a, e.model, t.slots);
        u && n.push(u);
      }), n;
    };
    return () => {
...
export {
  ...
  Te as bindMethod,
  Ge as default,
  qe as jsonFormDescriptionProps,
